...
This is a SC1015(Introduction to Data Science and Artificial Intelligence) Mini Project which has uses the [Cardiovascular Disease Dataset](https://www.kaggle.com/sulianova/cardiovascular-disease-dataset) from Kaggle.
